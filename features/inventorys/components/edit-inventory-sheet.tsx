...
export const EditInventorySheet = () => {
  ...
  const defaultValues = inventoryQuery.data
    ? {
        ...
        groupId: inventoryQuery.data.groupId,
        minDcs: inventoryQuery.data.minDcs ?? undefined,
        maxDcs: inventoryQuery.data.maxDcs ?? undefined,
        timePeriod: inventoryQuery.data.timePeriod ?? undefined,
